...
class ProjectItem extends Component {
  ...
  render() {
    ...
    const show = this.state.show ? 'img_show' : 'img_hide';

    const side = this.props.id % 2 === 0 ? 'img_left' : 'img_right';

    return (
      <div className="project_item project_border">
        <section className="project_text">
          <h3 className="project_id" >ID No. <span className="red">{this.props.id}</span></h3>
